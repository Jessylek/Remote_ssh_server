...
**Copy key to the VM**
type $env:USERPROFILE\.ssh\id_ed25519.pub | adminuser@SERVER_IP "mkdir -p ~/.ssh && chmod 700 ~/.ssh && cat >> ~/.ssh/authorized_keys && chmod 600 ~/.ssh/authorized_keys"
which is the equivalent of *ssh-copy-id adminuser@SERVER_IP* if you are working on a linux host
**Test**
